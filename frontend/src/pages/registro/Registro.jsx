...
function Registro() {
    ...
    const [_recaptchaToken, setRecaptchaToken] = useState(null);
        ...
        <div className="registro-page">
            ...
            <div className="registro-card">
                <div>
                    ...
                    <input type="text" id="nombre" name="nombre" required onChange={onChangeHandler} />
                    {errores.nombre && <div className="errorMensaje">{errores.nombre}</div>}
                </div>
                <div>
                    <label htmlFor="email">Email:</label>
                    <input type="email" id="email" name="email" required onChange={onChangeHandler} />
                    {errores.email && <div className="errorMensaje">{errores.email}</div>}
                </div>
                <div>
                    <label htmlFor="password">Contraseña:</label>
                    <input type="password" id="password" name="password" required onChange={onChangeHandler} />
                    {errores.password && <div className="errorMensaje">{errores.password}</div>}
                </div>
                <div>
                    <label htmlFor="repetirPassword">Repetir contraseña:</label>
                    <input type="password" id="repetirPassword" name="repetirPassword" required onChange={onChangeHandler} />
                ...
                <div className="politica-row">
                    <input type="checkbox" id="politica" name="politica" required onChange={onChangeHandler} />
