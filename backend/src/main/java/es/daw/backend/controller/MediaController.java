...
public class MediaController {
    ...
    public ResponseEntity<Resource> getMedia(@PathVariable String id) {
        ...
        if (peliculaOpt.isPresent()) {
            ...
            // ========= aquí podemos descomentar para alquilar sin seguridad--------------
            if (email.equals("anonymousUser") || !alquilerService.esAlquilerValido(email, pelicula.getId())) {
                throw new PeliculaNoAlquiladaException(
                        "No tienes un alquiler activo para la película: " + pelicula.getTitulo());
            }
            // =========================
